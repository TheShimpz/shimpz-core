"""Structured audit log for every mutating cf-driver operation.
...
AUDIT_PATH = Path(os.environ.get("SHIMPZ_CFDRIVER_AUDIT_LOG", "/var/log/cf-driver/audit.jsonl"))
...
def log(
    ...
    `subject` is whatever this op is about (a fqdn, a zone id, …) — returns the trace_id
