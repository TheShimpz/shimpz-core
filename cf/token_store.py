...
TOKEN_PATH = Path(os.environ.get("SHIMPZ_CFDRIVER_TOKEN_FILE", "/run/shimpz-cfdriver/token"))
TOKEN_GROUP = os.environ.get("SHIMPZ_CFDRIVER_TOKEN_GROUP", "shimpzcfdriver-token")
