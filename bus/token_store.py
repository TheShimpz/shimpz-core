...
TOKEN_PATH = Path(os.environ.get("SHIMPZ_BUSDRIVER_TOKEN_FILE", "/run/shimpz-busdriver/token"))
TOKEN_GROUP = os.environ.get("SHIMPZ_BUSDRIVER_TOKEN_GROUP", "shimpzbusdriver-token")
